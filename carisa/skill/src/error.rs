...
//!
//! Provides [`MarkdownError`] for parsing failures and [`LoadError`]
//! for skill-not-found scenarios.
...
mod tests {
    ...
    fn yaml_parse_with_id_includes_id_in_display() {
        ...
        let yaml_err = serde_saphyr::from_str::<serde::de::IgnoredAny>(bad_yaml).unwrap_err();
